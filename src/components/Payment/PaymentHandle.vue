    ...
    try {
        ...
        if (paymentStore.payloadTimePurchase.customerId !== "") {
            if (responseCode.value === "00") {
                ...
                paymentStore.payloadTimePurchase.paymentTime = parseDateTimeString(payDate.value);
                const purchasePayload = {
                    ...
                    playHoursMinuteString: paymentStore.payloadTimePurchase.playHoursMinuteString
                }
                console.log("This is purchasePayload: ", purchasePayload);
                const purchaseResponse = await axios.post(`http://localhost:8080/courtmaster/booking/payment-play-time`, purchasePayload)
