<template>
  <div class="booking-type">
      ...
      <div class="slot-container">
        ...
        <div class="time-slots">
          <div class="time-slot">
            ...
            <input
              type="time"
              v-model="slot.startTimeSlot"
              @change="validateTimeSlot(slot)"
            />
          </div>
          <div class="time-slot">
        ...
        <p v-if="slot.priceError" class="error-message">
          {{ slot.priceError }}
        </p>
    ...
    <div class="safety-submit">
      <div class="assurance">
        <h4>
          <i>I assure that all information provided in this form is correct</i>
        </h4>
        <input type="checkbox" v-model="isAssured" />
      </div>
      <button
        class="register-btn"
        :disabled="!isAssured || !isFormValid"
        @click="register"
      >
        Register
      </button>
