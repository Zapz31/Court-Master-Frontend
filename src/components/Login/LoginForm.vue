...
.logoGG_img {
  ...
  display: flex;
  align-items: center; /* Center-aligns the image within the div */
}

.logoGG_img img {
  width: 80%; /* Ensure the image fills the parent div */
  height: auto;
}

.logoGG_text {
  display: flex;
  align-items: center; /* Center-aligns the text within the div */
  font-size: 16px; /* Adjust font size as needed */
  margin-left: 10px; /* Add margin to space out from the image */
}
